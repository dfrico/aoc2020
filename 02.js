...
passwords.map(([policy, password]) => {
  ...
  // const numOfChars = password.replace(re, "").length;
  ...
  // // password index starts at 1
  // if (
  //   (passChars[+min - 1] === char && passChars[+max - 1] !== char) ||
  //   (passChars[+min - 1] !== char && passChars[+max - 1] === char)
  // ) {
  //   valid += 1;
  // }
...
console.log(valid, "out of", Object.keys(passwords).length);
